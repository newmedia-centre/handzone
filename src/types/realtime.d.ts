...
/**
 * Struct containing all of the data send using the realtime 5.10 protocol https://s3-eu-west-1.amazonaws.com/ur-support-site/16496/ClientInterfaces_Realtime.pdf
 *
 * This interface was referenced by `Realtime`'s JSON-Schema
 * via the `definition` "RealtimeData".
 */
