...
//Link to Used Movement Model:
//https://gist.github.com/FreyaHolmer/650ecd551562352120445513efa1d952

[RequireComponent(typeof(Camera))]
public class NonVRMovement : MonoBehaviour
{
    public float acceleration = 10; // how fast you accelerate
    public float accSprintMultiplier = 3; // how much faster you go when "sprinting"
    public float lookSensitivity = 0.5F; // mouse look sensitivity
